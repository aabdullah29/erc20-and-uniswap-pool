...
async function main() {
  ...
  writeAddressInFile('./scripts/addresses.js', 'TETHER_ADDRESS', tether.address);
  writeAddressInFile('./scripts/addresses.js', 'USDC_ADDRESS', usdc.address);
  writeAddressInFile('./scripts/addresses.js', 'WRAPPED_BITCOIN_ADDRESS', wrappedBitcoin.address);
}
